...
namespace
{
    void AndroidHandleMobileLink( const QString& subj, const QString& bod )
    {
        ...
        QAndroidJniObject::callStaticMethod<void>( "com/mycompany/myapp/MyAppActivity",
            "sendMailWithSubject", "(Ljava/lang/String;Ljava/lang/String;)V",
            subject.object<jstring>(), body.object<jstring>() );
        return;
    }
} // namespace
} // namespace project
